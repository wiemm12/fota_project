...
#define STM32F407_SRAM1_SIZE             (128 * 1024)  // Main SRAM1
#define STM32F407_CCMRAM_SIZE            (64 * 1024)   // Core Coupled Memory (CCMRAM)
#define STM32F407_FLASH_SIZE             (1024 * 1024) // 1MB Flash

#define STM32F407_SRAM1_END              (SRAM1_BASE + STM32F407_SRAM1_SIZE)
#define STM32F407_CCMRAM_END             (CCMDATARAM_BASE + STM32F407_CCMRAM_SIZE)
